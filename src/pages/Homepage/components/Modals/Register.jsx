...
const Register = () => {
    return (
        <form className="flex flex-col gap-5">
            ...
            <div className="flex flex-col w-full gap-2">
                <label htmlFor="email" className="text-zinc-200">E-posta</label>
                <input
                    className="p-3 bg-zinc-800 border border-zinc-700 rounded-lg outline-none focus:border-amber-500 transition-colors text-white"
                    id="email"
                    type="email"
            ...
            <div className="flex flex-col w-full gap-2">
                <label htmlFor="repassword" className="text-zinc-200">Tekrar Şifre</label>
                <input
                    className="p-3 bg-zinc-800 border border-zinc-700 rounded-lg outline-none focus:border-amber-500 transition-colors text-white"
                    id="repassword"
                    type="password"
            ...
            <Button >
                <input type="submit" value="Kayıt Ol" className="cursor-pointer text-center w-full" />
            </Button>
        </form>
    )
}
