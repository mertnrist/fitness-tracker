...
const ExercisesEditModal = ({ isEditModalOpen, setIsEditModalOpen, selectedExercise, handleEditSubmit, newNotes, newWeight, nextNotes, nextWeight, getSuggestedWeight }) => {
    return (
        <Modal
...
export default ExercisesEditModal
